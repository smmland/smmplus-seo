<x-filament-panels::page>
    ...
    <x-filament::section heading="AI Costs" description="Estimated spend on AI translation calls (blog articles and service descriptions combined), based on approximate published per-model pricing - actual provider invoices may differ slightly.">
