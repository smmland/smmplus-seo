...
class TelegramAlerts extends Page implements HasForms
{
    ...
    public function mount(TelegramAlertSettingsService $settings): void
    {
        $this->form->fill([
            ...
            'onAttackDetected' => $settings->isOnAttackDetectedEnabled(),
            ...
            ->schema([
                Section::make('Personal alerts')
                    ...
                    ->schema([
                        ...
                        Toggle::make('onAttackDetected')
                            ->label('A possible attack is detected on the Free Service Gateway (and when it subsides)'),
    ...
    public function save(TelegramAlertSettingsService $settings): void
    {
        ...
        $settings->setOnAttackDetectedEnabled((bool) $data['onAttackDetected']);
